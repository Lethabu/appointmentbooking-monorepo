-- Migration: Sync Instyle Services
-- Generated by supersaas-complete-sync.js
-- Date: 2025-11-28

-- 1. Clean up existing services for this tenant to avoid duplicates
DELETE FROM services WHERE tenant_id = 'ccb12b4d-ade6-467d-a614-7c9d198ddc70';

-- 2. Insert fresh data from SuperSaaS analysis
