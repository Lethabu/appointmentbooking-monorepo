-- Complete SuperSaaS to Platform Sync - ALL 5 Services
-- Based on actual booking data + estimates for unused services

DELETE FROM services WHERE tenant_id = 'ccb12b4d-ade6-467d-a614-7c9d198ddc70';

-- Insert ALL 5 SuperSaaS services with complete pricing
